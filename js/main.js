...
var startKeys = [32, 40, 83, 13];//An array of keys to press to start the game, read the instructions in the index to determine what keycodes should go here
var eggsMissed = 0;
var score = 0;
...
$(document).ready(function(){
    ...
    $("#egg-drop-game").on("animationEnd webkitAnimationEnd",".egg",function(){
        ...
        var basketRightEdge = basketLeftEdge + $("#basket").width();
